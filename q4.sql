...
select country.name, party_position.party_id, left_right
...
group by name
having left_right >= 0 and left_right < 2
;

create view count2 AS
select name, count(*) as c2
group by name
having left_right >= 2 and left_right < 4
;

create view count3 AS
select name, count(*) as c3
group by name
having left_right >= 4 and left_right < 6
;

create view count4 AS
select name, count(*) as c4
group by name
having left_right >= 6 and left_right < 8
;

create view count5 AS
select name, count(*) as c5
group by name
having left_right >= 8 and left_right < 10
;
